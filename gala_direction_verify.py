...
DATA_PATH = '/Users/jimingzhang/Desktop/crypto_data_Pre5m/GALA_USDT_5m_from_20180101.csv'
OUT = '/Users/jimingzhang/kronos/market_sense_results/gala_direction.json'
...
if __name__ == '__main__':
    ohlc = load_ohlc()
    print(f'GALA 1h: {len(ohlc)} bars | {ohlc.index[0].date()} ~ {ohlc.index[-1].date()}')
    strategies = [
